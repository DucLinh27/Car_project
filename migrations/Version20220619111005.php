 ...
 */
final class Version20220619111005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, supplier_id_id INT DEFAULT NULL, car_name VARCHAR(255) NOT NULL, car_price VARCHAR(255) NOT NULL, INDEX IDX_773DE69DA65F9C7D (supplier_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, car_id_id INT DEFAULT NULL, customer_id_id INT DEFAULT NULL, date_order DATE NOT NULL, INDEX IDX_F5299398A0EF1B80 (car_id_id), INDEX IDX_F5299398B171EB6C (customer_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
